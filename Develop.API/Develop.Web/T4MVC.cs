...
{
    public static Develop.Web.Controllers.HomeController Home = new Develop.Web.Controllers.T4MVC_HomeController();
...
namespace Links
{
    ...
    public static class Assets {
        public const string UrlPath = "~/Assets";
        public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
        public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public static class css {
            public const string UrlPath = "~/Assets/css";
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
            public static readonly string bootstrap_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(UrlPath + "/bootstrap.min.css") ? Url("bootstrap.min.css") : Url("bootstrap.css");
            public static readonly string bootstrap_min_css = Url("bootstrap.min.css");
            public static readonly string sticky_menu_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(UrlPath + "/sticky-menu.min.css") ? Url("sticky-menu.min.css") : Url("sticky-menu.css");
        }
    
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public static class images {
            public const string UrlPath = "~/Assets/images";
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
            public static readonly string icon_wa_png = Url("icon-wa.png");
        }
    
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public static class js {
            public const string UrlPath = "~/Assets/js";
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
            ...
            public static readonly string sticky_menu_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(UrlPath + "/sticky-menu.min.js") ? Url("sticky-menu.min.js") : Url("sticky-menu.js");
        }
    ...
    public static partial class Bundles
    {
        ...
        public static partial class Assets 
        {
            public static partial class css 
            {
                public static class Assets
                {
                    public static readonly string bootstrap_css = T4MVCHelpers.ProcessAssetPath("~/Assets/css/bootstrap.css");
                    public static readonly string bootstrap_min_css = T4MVCHelpers.ProcessAssetPath("~/Assets/css/bootstrap.min.css");
                    public static readonly string sticky_menu_css = T4MVCHelpers.ProcessAssetPath("~/Assets/css/sticky-menu.css");
                }
            }
            ...
            public static partial class js 
            {
                public static class Assets
                {
                    public static readonly string bootstrap_js = T4MVCHelpers.ProcessAssetPath("~/Assets/js/bootstrap.js"); 
                    public static readonly string bootstrap_min_js = T4MVCHelpers.ProcessAssetPath("~/Assets/js/bootstrap.min.js"); 
                    public static readonly string jquery_easing_min_js = T4MVCHelpers.ProcessAssetPath("~/Assets/js/jquery.easing.min.js"); 
                    public static readonly string jquery_js = T4MVCHelpers.ProcessAssetPath("~/Assets/js/jquery.js"); 
                    public static readonly string sticky_menu_js = T4MVCHelpers.ProcessAssetPath("~/Assets/js/sticky-menu.js"); 
                }
            }
        }
    }
